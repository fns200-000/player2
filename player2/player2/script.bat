...
echo esse nome...
%wait%
echo vc esta usando o nome do desenvolvedor?
%wait%
echo por acaso vc e o ADM?
%wait%
%wait%
%wait%
%wait%
echo a penas escreva sim ou nao
%wait%
set /p input=*
echo.
...
:sim
%wait%
echo wow mds que legal adm Eu estou muito feliz.
%wait%
echo Entao, nao vou matar o seu PC Tchau ADM.
pause
Exit

:nao
%wait%
echo mds Entao so nao usa esse nome Humano
%wait%
echo Então, eu vou matar o seu PC
cls
